...
var figlet = figlet || (function() {
    ...
    */
    ...
    function generateFigTextLines(txt, figChars, opts) {
        var charIndex, figChar, overlap = 0, row, outputFigText = [], len=opts.height, outputFigLines = [], maxWidth;
        ...
        // last line if option.width was set or the only line otherwise
        outputFigLines.push(outputFigText);
        // remove hardblanks
